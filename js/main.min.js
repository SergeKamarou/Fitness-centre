...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_slider__WEBPACK_IMPORTED_MODULE_3__["initSliders"])();
...
var trainersSliderContainer = document.querySelector('.trainers__wrap');
var reviewsSliderContainer = document.querySelector('.reviews__wrap');
var initSliders = function initSliders() {
  if (trainersSliderContainer) {
    ...
    var trainersSlider = new Swiper('.swiper--trainers', {
      ...
      on: {
        init: function init() {
          var sliderDuplecateElements = trainersSliderContainer.querySelectorAll('.swiper-slide-duplicate');
          sliderDuplecateElements.forEach(function (item) {
            item.setAttribute('tabindex', '-1');
          });
        },
        slideChange: function slideChange() {
          trainersSliderContainer.querySelectorAll('.swiper-slide').forEach(function (item) {
            item.setAttribute('tabindex', '-1');
          });
          var activeSlides = trainersSliderContainer.querySelectorAll('.swiper-slide-visible');
  ...
  if (reviewsSliderContainer) {
    ...
    var reviewsSlider = new Swiper('.reviews__slider-wrap', {
      direction: 'horizontal',
      slidesPerView: 1,
      keyboard: {
        enabled: true
...
var tabItemElements = document.querySelectorAll('[data-tab]');
var tabItemPriceElements = document.querySelectorAll('[data-price]');
var tabItemDefault = document.querySelector('.subscriptions__tab-list--default');
var tabClickHandler = function tabClickHandler(item) {
  item.addEventListener('click', function (evt) {
    evt.preventDefault();
    var currentButton = item;
    var tabId = currentButton.getAttribute('href').replace('#', '');
    var currentTab = document.getElementById(tabId);
    if (!currentButton.classList.contains('is-current')) {
      tabButtons.forEach(function (button) {
        button.classList.remove('is-current');
      });
      tabItemElements.forEach(function (tabItem) {
...
var setTabTextShadow = function setTabTextShadow() {
  tabItemPriceElements.forEach(function (item) {
    var priceContent = item.textContent.replace('₽', '');
